...
luminosity = data[2809].astype(float)
...
#ncoded = Dense(2000, kernel_regularizer=keras.regularizers.l1(10e-5))(input_layer)
...
ae_scores.append(predictions)
ms_scores.append(mean_square)
rf_scores.append(rf_score)
true_labels.append(y_test.values)
  
pickle.dump(predictions, open(model_directory + "ae_pred08_no_reg.p", "wb"))
pickle.dump(ae_scores, open(model_directory + "ae_scores08_no_reg.p", "wb"))
