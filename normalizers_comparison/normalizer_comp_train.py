...
model_directory = "./normalizer_comp_files/"
model_name = "normalizer_comp_model"
...
# Features
X = data.values[:, :2807] # 2807 features
...
def get_error_df(X_test, predictions, mode="topn", n_highest = 100):
...
normalizers = [StandardScaler(), MinMaxScaler(), MaxAbsScaler(), RobustScaler(), Normalizer(), QuantileTransformer(), QuantileTransformer(output_distribution='normal')]
