...
from keras.activations import sigmoid, linear, hard_sigmoid
...
model_directory = "/eos/user/t/tkrzyzek/autoencoder/lumi_dep/split01_hard_sigmoid/"
model_name = "model"
