...
model_directory = "./model_comp_train_files/"
model_name = "model_comp_train"
...
skf = TimeSeriesSplit(n_splits=SPLIT_FACTOR)
...
for index, (train_indices, test_indices) in tqdm(enumerate(skf.split(X, y))):
