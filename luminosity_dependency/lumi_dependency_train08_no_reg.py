...
model_directory = "/eos/user/t/tkrzyzek/autoencoder/lumi_dep/split08/"
model_name = "model08_no_reg"
...
pickle.dump(predictions, open(model_directory + "ae_pred_no_reg.p", "wb"))
