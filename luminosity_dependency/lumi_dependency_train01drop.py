...
model_directory = "/eos/user/t/tkrzyzek/autoencoder/lumi_dep/split01drop/"
model_name = "model01drop"
...
x = Dense(2000, kernel_regularizer=keras.regularizers.l1_l2(10e-5))(x)
x = PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None)(x)

x = Dropout(0.3)(x)
x = Dense(1000, kernel_regularizer=keras.regularizers.l1_l2(10e-5))(x)
x = PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None)(x)

x = Dropout(0.3)(x)
x = Dense(500, kernel_regularizer=keras.regularizers.l1_l2(10e-5))(x)
x = PReLU(alpha_initializer='zeros', alpha_regularizer=None, alpha_constraint=None, shared_axes=None)(x)
